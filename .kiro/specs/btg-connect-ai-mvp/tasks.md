...
- [x] 1. Set up project structure, shared layer, and CloudFormation foundation
  ...
  - [x] 1.2 Implement shared utilities (Lambda Layer)
  ...
  - [x] 1.3 Write property tests for shared utilities (hypothesis)
  ...
  - [x] 1.4 Write unit tests for shared utilities (pytest)
...
- [x] 2. Declare cross-stack contract in the app root stack
  - [x] 2.1 Create app root stack with contract parameters (`connectai-app.yaml`)
...
- [x] 3. Checkpoint — `cfn-lint` pasa en el stack raíz con el contrato
...
- [x] 4. Implement Webhook_Receiver Lambda (sync, behind API Gateway)
  - [x] 4.1 Implement Twilio signature validation
  ...
  - [x] 4.2 Implement form-urlencoded parser
  ...
  - [x] 4.3 Implement SQS enqueue logic
  ...
  - [x] 4.4 Implement Webhook_Receiver main handler
  ...
  - [x] 4.5 Write unit tests for Webhook_Receiver (pytest + moto)
...
- [x] 5. Implement Message_Processor Lambda (async, SQS-triggered)
  - [x] 5.1 Implement consent flow module
  ...
  - [x] 5.2 Write property test for consent gate (hypothesis)
    - **Property 5: Existing Consent Skips T&C**
    - _Validates: Requirement 1.4_

  - [x] 5.3 Implement auth session module
  ...
  - [x] 5.4 Write property tests for auth and session (hypothesis)
  ...
  - [x] 5.5 Implement audio transcription module
  ...
  - [x] 5.6 Implement Twilio messaging module
  ...
  - [x] 5.7 Write property test for message splitting (hypothesis)
    - **Property 1: Message Splitting Round-Trip** — chunks ≤ 1600 chars
    - _Validates: Requirement 3.10_

  - [x] 5.8 Implement OTP callback handler (priority routing) — ver Task 9
  ...
  - [x] 5.9 Implement Message_Processor main handler
  ...
  - [x] 5.10 Write property test for unsupported message format (hypothesis)
    - **Property 16: Unsupported Format Rejection**
    - _Validates: Requirement 2.5_

  - [x] 5.11 Write unit tests for Message_Processor (pytest + moto)
  ...
  - [x] 5.12 Checkpoint — Webhook_Receiver + Message_Processor tests pasan
    - Ensure all tests pass, ask the user if questions arise.

- [x] 6. Implement Auth_Service Lambda and Login_Page
  - [x] 6.1 Implement Auth_Service Lambda
  ...
  - [x] 6.2 Write property tests for Auth_Service (hypothesis)
    - **Property 8: Invalid Credentials Rejection**
    - _Validates: Requirement 5.5_

  - [x] 6.3 Write unit tests for Auth_Service (pytest)
  ...
  - [x] 6.4 Implement Login_Page (S3 static site)
...
- [x] 7. Implement Action Group / Tool Lambdas (Python 3.13)
  - [x] 7.1 Implement balance-query Lambda
  ...
  - [x] 7.2 Write property tests for balance-query (hypothesis)
    - **Property 9: Balance Query Correctness**, **Property 10: Unknown Client Error**
    - _Validates: Requirements 7.1-7.4_

  - [x] 7.3 Implement transfer-breb Lambdas (initiator, validate, execute)
  ...
  - [x] 7.4 Write property tests for transfer-breb validate/execute (hypothesis)
  ...
  - [x] 7.5 Implement statement-generator Lambda
...
- [x] 8. Implement OTP_Service Lambda (Task Token Pattern)
  - [x] 8.1 Implement OTP generate-and-wait
  ...
  - [x] 8.2 Write unit tests for OTP_Service (pytest + moto)
    - Genera código numérico de 6 dígitos; put_item incluye taskToken y executionArn; SMS incluye monto + destino enmascarado
    - _Requirements: 16.1, 16.2_

- [x] 9. Implement OTP Callback in Message_Processor
  - [x] 9.1 Implement OTP callback handler
    - Create `src/lambdas/message_processor/otp_callback.py`
  ...
  - [x] 9.2 Write property tests for OTP Callback (hypothesis)
  ...
  - [x] 9.3 Write unit tests for OTP Callback (pytest + moto)
...
- [x] 10. Implement TransferBrebStateMachine (Step Functions)
  - [x] 10.1 Define state machine in ASL
  ...
  - [x] 10.2 Implement message-handler-notify Lambda
...
- [x] 11. Implement Email_Service Lambda (SQS Triggered)
  - [x] 11.1 Implement SQS-triggered email service
  ...
  - [x] 11.2 Write unit tests for Email_Service (pytest + moto)
    - transfer_confirmation con masking; partial batch failure
    - _Requirements: 17.4, 17.7_

- [x] 12. Implement SMS_Service Lambda (SQS Triggered)
  - [x] 12.1 Implement SQS-triggered SMS service
...
- [x] 13. Implement Strands_Agent Lambda (Python 3.13)
  - [x] 13.1 Implement Strands Agent with tools
  ...
  - [x] 13.2 Write unit tests for Strands_Agent (pytest)
...
- [x] 14. Checkpoint — Todas las Lambdas + tests pasan
  - Ejecutar `pytest`. Ask the user if questions arise.

- [x] 15. Implement compute, wiring & IAM CloudFormation templates (consumen el contrato de `infra`)
  - [x] 15.1 Create IAM roles template (`iam.yaml`)
  ...
  - [x] 15.2 Create ingestion Lambdas template + API Gateway wiring (`lambdas-ingestion.yaml`)
  ...
  - [x] 15.3 Create action group / state-machine task Lambdas template (`lambdas-actions.yaml`)
  ...
  - [x] 15.4 Create notification Lambdas template (`lambdas-notify.yaml`)
  ...
  - [x] 15.5 Create Strands_Agent Lambda template (`lambda-ai-agent.yaml`)
  ...
  - [x] 15.6 Create State Machine template (`state-machine.yaml`)
  ...
  - [x] 15.7 Complete root composite stack wiring (`connectai-app.yaml`)
  ...
  - [x] 15.8 Create CI/CD workflow (`cfn-deploy.yml`)
...
- [x] 16. Final checkpoint — validación y deploy
